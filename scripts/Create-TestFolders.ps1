...
$root = Join-Path ([System.IO.Path]::GetTempPath()) 'FolderGlimpseTest'
...
Set-Content -LiteralPath (Join-Path $small 'README.md') -Value '# FolderGlimpse test file'
...
Write-Host "Created FolderGlimpse fixtures at $root"
