...
public partial class PreviewWindow : Window
{
    ...
    private FolderPeekSettings _settings = FolderPeekSettings.Default;
    ...
    internal void ConfigureInteraction(bool sticky, FolderPeekSettings settings)
    {
        _settings = settings;
    ...
    internal void ShowBeside(PixelRect anchor, FolderPeekSettings settings, bool sticky = false)
    {
        _lastAnchor = anchor;
        SetDetached(false);
